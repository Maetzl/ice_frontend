...
export default function Library() {
  ...
  const [library, setLibrary] = useState([{ name: "", description: "", price: 0 }]);
  const [selectedGame, setGame] = useState({ name: "", description: "", price: 0 });
  ...
  function handleSetGame(game: { name: string; description: string; price: number; }): void {
    setGame(game);
  }
